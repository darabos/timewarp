...
void draw_allegro_pmask(struct PMASK *mask, struct BITMAP *destination, int x, int y, int color) ;
void draw_allegro_pmask_stretch(struct PMASK *mask, struct BITMAP *destination, int x, int y, int w, int h, int color) ;
#endif
