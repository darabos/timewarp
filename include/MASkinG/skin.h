	...
	public:
		...
		*/
		...
		/**
			...
			Note: This function sets the Allegro config file to the skin file you specified,
			so if you want to read generic Allegro configuration from another file (like
			allegro.cfg) you will need to set it again yourself.
		*/
