...
class Widget : public Rect {
	...
	protected:
		...
		*/
		virtual void SetCursor(int i) const;
	...
	public:
		...
		*/
		...
		/**
			...
			text and the text shadow and the font indices in the skins font array for
			all four possible states (NORMAL, SELECTED, DISABLED and FOCUSED). This is
			obviously relevant only for widgets that actually contain some sort of text.
		*/
