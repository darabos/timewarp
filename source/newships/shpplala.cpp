...
//	void show_panel( int r );  
	...
	virtual void calculate_hotspots();  // enable/disable hotspots
};


PlanetLander::PlanetLander(Vector2 opos, double angle, ShipData *data, unsigned int code) /*Vector2 opos, double shipAngle, ShipData *shipData, unsigned int code)*/ 
:
	Ship(opos, angle, data, code)
{
	...
	shipConfig				= get_config_int("Configuration", "ActiveConfig",0);
	
	//interialessOn			= get_config_int(
}
