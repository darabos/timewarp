...
class ArilouTrapper : public Ship
{
 ...
 public:
  ...
  virtual int handle_damage(SpaceLocation* source, double normal, double direct);  // Takes half damage when in cloak (subquasi)
  ...
  void ArilouTrapper::calculate_thrust();     // This override increases max speed by a factor of 2.5 when in cloak (subquasi)
  void ArilouTrapper::calculate_turn_left();  // This override adds a thrust 45deg opposite of turn equal to 1/3 the normal thrust
  void ArilouTrapper::calculate_turn_right(); // This override adds a thrust 45deg opposite of turn equal to 1/3 the normal thrust
...
double ArilouTrapper::isInvisible()
  {
