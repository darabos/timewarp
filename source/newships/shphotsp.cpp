...
Ship(opos, angle, data, code) 
{
	...
	weaponVelocityStep	= get_config_float("Weapon", "VelocityStep", 0);
...
void ShpHotSpot::calculate()
{
	...
	if ( !corepresent )
	{
		coremaketime += frame_time * 1E-3;	// in seconds
...
int ShpHotSpot::activate_special()
{
	...
	if ( corepresent && batt > 0.75*batt_max )	// you can only drop a "cool" core if you've enough juice
	{
		corepresent = 0;
