...

{
  ...
  if (!mineactive) {
    ...
    if (t) {
      add(new Missile(this,0,(trajectory_angle(t)+5),
        missileVelocity,missileDamage,missileRange,missileArmour,
        this,data->spriteExtra));
      add(new Missile(this,0,(trajectory_angle(t)+15),
        missileVelocity,missileDamage,missileRange,missileArmour,
        this,data->spriteExtra));
      add(new Missile(this,0,(trajectory_angle(t)+25),
        missileVelocity,missileDamage,missileRange,missileArmour,
        this,data->spriteExtra));
      add(new Missile(this,0,(trajectory_angle(t)+35),
        missileVelocity,missileDamage,missileRange,missileArmour,
        this,data->spriteExtra));
      add(new Missile(this,0,(trajectory_angle(t)-5),
        missileVelocity,missileDamage,missileRange,missileArmour,
